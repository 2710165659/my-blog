import{_ as i,c as a,o as n,ag as l}from"./chunks/framework.S-Qvb3wi.js";const g=JSON.parse('{"title":"侧边栏","description":"","frontmatter":{},"headers":[],"relativePath":"vitepress-tutorial/reference/default-theme-sidebar.md","filePath":"vitepress-tutorial/reference/default-theme-sidebar.md"}'),p={name:"vitepress-tutorial/reference/default-theme-sidebar.md"};function h(t,s,e,k,E,d){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="sidebar" tabindex="-1">侧边栏 <a class="header-anchor" href="#sidebar" aria-label="Permalink to &quot;侧边栏 {#sidebar}&quot;">​</a></h1><p>侧边栏是文档的主要导航块。可以在 <a href="./default-theme-config#sidebar"><code>themeConfig.sidebar</code></a> 中配置侧边栏菜单。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
